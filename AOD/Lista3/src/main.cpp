...
int main()
{
	std::cout << "Running on " << "USA-road-d.NY" << std::endl;
	auto dijkstra_benchmark = aod::DijkstraBenchmark(
	...
	std::cout << "(Dijkstra) time elapsed: "
		<< std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count()
		<< " milliseconds and the path has "
		<< dijkstra_result[0].length
		<< " length."
		<< std::endl;
	...
	std::cout << "(Dijkstra Radix) time elapsed: "
		<< std::chrono::duration_cast<std::chrono::milliseconds>(end - start).count()
		<< " milliseconds and the path has "
		<< radix_dijkstra_result[0].length
		<< " length."
		<< std::endl;
